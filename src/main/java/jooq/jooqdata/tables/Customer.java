...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    /**
     * The column <code>purchase.customer.person_type</code>.
     */
    public final TableField<CustomerRecord, String> PERSON_TYPE = createField(DSL.name("person_type"), SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>purchase.customer.postal_address</code>.
     */
    public final TableField<CustomerRecord, String> POSTAL_ADDRESS = createField(DSL.name("postal_address"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>purchase.customer.email</code>.
     */
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, Keys.CUSTOMER__CUSTOMER_CUSTOMER_CODE_MAIN_FKEY, null);
    ...
    public LotPath lot() {
        if (_lot == null)
            _lot = new LotPath(this, null, Keys.LOT__LOT_CUSTOMER_CODE_FKEY.getInverseKey());
     ...
     */
    public <U> SelectField<U> mapping(Function13<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super Boolean, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function13<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super Boolean, ? super String, ? super String, ? super String, ? extends U> from) {
